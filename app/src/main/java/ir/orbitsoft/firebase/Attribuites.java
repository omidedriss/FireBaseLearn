...
public class Attribuites {
    ...
    final public static String FCM_TOPIC_GLOBAL = "global";
    final public static String FCM_TOPIC_ONSCREEN = "onscreen";
    final public static String FCM_TOPIC_VIP_USER = "vip_user";
    final public static String VIP_USER = "vipUser";
